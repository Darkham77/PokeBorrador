...
async function renderMaps() {
  ...
  try {
    ...
    if (!container) {
      ...
      html += `
        <div class="pc-split-container" style="display: flex; gap: 20px; margin-bottom: 12px; align-items: stretch; overflow: visible;">
          <div class="pc-left" style="flex: 1.5; overflow: visible;">
          ...
          <div class="pc-right" style="flex: 1; display: flex; min-width: 0; overflow: visible;">
