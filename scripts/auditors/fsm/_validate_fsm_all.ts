...
const FSM_VALIDATION_TASKS: Task[] = [
  { name: 'FSM Diagrams', args: ['scripts/auditors/fsm/validate_fsm_diagrams.ts'] },
  { name: 'FSM Implementation', args: ['scripts/auditors/fsm/validate_fsm_implementation.ts'] },
  { name: 'FSM Flow Parity', args: ['scripts/auditors/fsm/validate_fsm_flow_parity.ts'] }
];
