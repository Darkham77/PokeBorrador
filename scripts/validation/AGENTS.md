...
- [validate_abilities.ts](./validate_abilities.ts): Validates local ability tables against official PokeAPI endpoints.
...
- [generate_move_translations.ts](./generate_move_translations.ts): Creates custom move translation tables.
