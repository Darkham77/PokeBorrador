...
**Related skills:** For single tweens and eases use [gsap-core](../gsap-core/SKILL.md); for scroll-driven timelines use [gsap-scrolltrigger](../gsap-scrolltrigger/SKILL.md); for React use [gsap-react](../gsap-react/SKILL.md).
