...
**Related skills:** Use with [gsap-core](../gsap-core/SKILL.md), [gsap-timeline](../gsap-timeline/SKILL.md), and [gsap-scrolltrigger](../gsap-scrolltrigger/SKILL.md) when building animations; CustomEase and other easing utilities are in [gsap-plugins](../gsap-plugins/SKILL.md).
