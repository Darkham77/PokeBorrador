...
- **White-on-Solid Text Contrast**: Any badge or pill featuring white text on a solid color background (e.g., `.completed-badge`, `.class-level-badge`) MUST apply a solid black outline (`border: 1px solid #000000`) and a retro-style 4-way black text shadow (`text-shadow: 1px 1px 0 #000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000;`) to guarantee legibility on all displays and resolutions.
