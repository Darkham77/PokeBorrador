...
- [ ] **Code Modularity & Health**: Modularity governed by Fallow SSoT (`npm run audit:fallow`). Maintainability Index ≥ 85, cognitive and cyclomatic complexity within thresholds, and zero arbitrary raw line limits.
