...
| [Testing & Simulations](./testing_and_simulations.md) | CLI-first debugging, Playwright E2E simulation rules, passive joystick law, 10s timeout limit, mandatory `#id` locators, 100% shared battle runners. | For browser manual QA steps ➔ [`../qa/browser_testing_manual.md`](../qa/browser_testing_manual.md). For battle state machine ➔ [`../battle/battle_mechanics_manual.md`](../battle/battle_mechanics_manual.md). |
