...
| [Game Engine & State](./game_engine_and_state.md) | Showdown canonical source of truth (`ACTIVE_GENERATION`), 4-seat generic compatibility, zero-cloning Pokémon instances, Showdown ID formatting, illegal Pokémon quarantine. | For battle engine turn logic & worker sync ➔ [`../battle/battle_mechanics_manual.md`](../battle/battle_mechanics_manual.md). For battle math formulas ➔ [`../core/game_formulas_manual.md`](../core/game_formulas_manual.md). |
