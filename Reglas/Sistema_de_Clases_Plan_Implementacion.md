...
### FASE 1 — Infraestructura Base (js/04_state.js)
...
**Paso 1.3** — Crear `js/20_classes.js` con:
...
### FASE 2 — Selector de Clase (UI en index.html + js/20_classes.js)
...
### FASE 3 — Modificadores de Combate y Experiencia (js/07_battle.js)
...
### FASE 4 — Modificadores de Captura (js/06_encounters.js)
...
### FASE 5 — Centro Pokémon y Guardería (js/08_shop.js + js/15_breeding.js)
...
### FASE 6 — Mercado Negro del Rocket (js/08_shop.js o nuevo js/20_classes.js)
...
### FASE 7 — Sistema Idle de Clases (js/04_state.js o js/20_classes.js)
...
### FASE 8 — Análisis Genético del Criador (js/12_box_bag.js)
...
### FASE 9 — Reputación del Entrenador (js/07_battle.js + js/08_shop.js)
...
|---|---|---|
| `js/04_state.js` | Modificar | Añadir campos de clase al INITIAL_STATE |
| `js/07_battle.js` | Modificar | EXP/BC multipliers, Robo Rápido, catchRate ajustes |
| `js/06_encounters.js` | Modificar | Racha de capturas, Zonas Privilegiadas |
| `js/08_shop.js` | Modificar | Costos de curación, Mercado Negro, tienda Reputación |
| `js/15_breeding.js` | Modificar | Herencia Élite, Everstone 100%, tiempo eclosión |
| `js/12_box_bag.js` | Modificar | Análisis Genético del Criador |
| `js/20_classes.js` | **Crear** | Motor principal del sistema de clases |
