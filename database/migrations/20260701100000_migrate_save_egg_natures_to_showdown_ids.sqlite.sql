-- SQLite Companion Migration: 20260701100000_migrate_save_egg_natures_to_showdown_ids
-- Description: Converts nature IDs in local sqlite save_data to pure Showdown format for eggs.
...
VALUES ('db_version', '20260701100000', strftime('%Y-%m-%dT%H:%M:%SZ', 'now'))
