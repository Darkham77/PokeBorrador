-- SQLite Companion Migration: 20260830234500_fix_events_config_rls_and_canonical_seed
-- Description: Ensures complete canonical 12-event grid in SQLite.
...
VALUES ('db_version', '20260830234500', strftime('%Y-%m-%dT%H:%M:%SZ', 'now'))
