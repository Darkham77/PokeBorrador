-- =====================================================
-- FIX CLAIM ITEMS IN claim_asset_v2
-- Fecha: 2026-05-19
-- =====================================================
...
INSERT INTO public.system_config (key, value) VALUES ('db_version', '20260519235000'::jsonb) ON CONFLICT (key) DO UPDATE SET value = EXCLUDED.value, updated_at = NOW();
