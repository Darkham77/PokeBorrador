...
CREATE TABLE IF NOT EXISTS public.ranked_rules_config (
    ...
    config JSONB NOT NULL DEFAULT '{"maxPokemon":6,"levelCap":50,"allowedTypes":[],"bannedPokemonIds":[]}'::jsonb,
...
VALUES (
  'current',
  'TEMPORADA ACTUAL',
  '{"maxPokemon":6,"levelCap":50,"allowedTypes":[],"bannedPokemonIds":[]}'::jsonb
)
