import{q as g,I as c,a0 as v,E as i,f as C,a2 as u,e as o,h as r,F as f,J as y,U as P,a5 as E,z as B,Q as F,n as T,a as x,g as S,c as V}from"./vendor-vue-BZQIsCAw.js";import{a0 as z,ao as k,X as L}from"./index-B66ZgMUW.js";import"./vendor-db-By8kpymX.js";const A={gimnasios:`
  ...
  `},q=[{id:"gimnasios",label:"🏆 Gimnasios"},{id:"captura",label:"🔴 Captura"},{id:"clases",label:"🎭 Clases"},{id:"crianza",label:"🥚 Crianza"},{id:"misiones",label:"📋 Misiones"},{id:"encuentros",label:"🗺️ Encuentros"},{id:"shinys",label:"✨ Shinys"},{id:"combate",label:"⚔️ Combate"},{id:"guerra",label:"🛡️ Guerra"},{id:"eventos",label:"📅 Eventos"},{id:"clima",label:"🌦️ Clima"}],_={class:"library-container"},N={class:"library-sidebar"},M={class:"library-nav custom-scrollbar-vicio"},R=["onClick"],D={class:"library-content custom-scrollbar-vicio"},H=["innerHTML"],j=g({__name:"LibraryModal",props:{show:{type:Boolean,default:!1},initialTab:{default:"gimnasios"}},emits:["close"],setup(d,{emit:h}){const s=d,m=h,e=c(s.initialTab||"gimnasios"),l=c(!0);v(()=>s.initialTab,a=>{a&&(e.value=a)});const p=V(()=>A[e.value]||"<h1>Próximamente</h1><p>En construcción.</p>"),b=a=>{e.value!==a&&(l.value=!1,k.delayedCall(.15,()=>{e.value=a,l.value=!0}))};return(a,n)=>(i(),C(z,{show:d.show,"max-width":"1200px",title:"BIBLIOTECA","title-color":"var(--yellow)","header-background":"#161a2e","show-close-button":!0,padding:"raw","no-scroll":"",onClose:n[0]||(n[0]=t=>m("close"))},{default:u(()=>[o("div",_,[o("aside",N,[o("nav",M,[(i(!0),r(f,null,y(P(q),t=>(i(),r("div",{key:t.id,class:B(["library-nav-item",{active:e.value===t.id}]),onClick:E(G=>b(t.id),["stop"])},F(t.label),11,R))),128))])]),o("main",D,[T(x,{name:"fade"},{default:u(()=>[l.value?(i(),r("div",{key:0,id:"library-article-content",class:"library-article",innerHTML:p.value},null,8,H)):S("",!0)]),_:1})])])]),_:1},8,["show"]))}}),U=L(j,[["__scopeId","data-v-010de2ac"]]);export{U as default};
