...
- **Time Synchronization**: All event active windows and competition validations must use server-synchronized timestamps from `@/logic/utils/timeUtils.ts` (`getServerTime()`, `getServerInstant()`).
