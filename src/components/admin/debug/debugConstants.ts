...
export const DEBUG_WEATHER_EFFECTS = [
  ...
  { id: 'cold', label: 'FRÍO', icon: '❄️', desc: 'Ambiente gélido. Potencia Defensa Hielo (x1.5). Ventisca 100% precisión.' },
  ...
  { id: 'coldwave', label: 'OLA FRÍO', icon: '🥶', desc: `Frío extremo. Daño ${SANDSTORM_HAIL_CHIP_DAMAGE_FRACTION_TEXT} HP a no-Hielo por turno. Ventisca 100% precisión.` },
  { id: 'fog', label: 'NIEBLA', icon: '🌫️', desc: 'Reduce la precisión de todos los movimientos a x0.6.' },
  { id: 'mist', label: 'BRUMA', icon: '💨', desc: 'Humedad mágica y niebla ligera. Reduce la precisión a x0.6.' },
