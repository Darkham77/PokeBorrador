...
6. **Canonical Zoom Scale Bounds**: The adventure camera zoom scale must adhere to the bounded range `[0.4, 2.4]`. Parked mode initial scale dynamically accommodates viewport dimensions (starting at ~1.44 on desktop 1280x720) without exceeding the maximum scale bound.
