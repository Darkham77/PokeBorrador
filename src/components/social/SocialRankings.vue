...
import { useSocialStore } from '@/stores/social/social.js'
...
const isFactionValid = (faction: string | undefined | null) => {
  return !!(faction && faction !== 'null' && faction !== 'NULL' && faction !== 'undefined' && faction.trim() !== '' && faction.toLowerCase() !== 'none') // text-ok: UI text display localization string
}
</script>
