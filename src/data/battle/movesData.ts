...
const MOVES_DATABASE: Readonly<Record<PokemonMoveId, MoveBaseData>> = (movesDataJson as Record<string, unknown>) as Readonly<Record<PokemonMoveId, MoveBaseData>>; // open-record: Generic key-value data dictionary container
