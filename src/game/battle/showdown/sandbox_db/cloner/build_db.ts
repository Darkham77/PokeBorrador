...
const DATA_DIR = path.resolve('src/game/battle/showdown/sandbox_db/data');
...
async function main() {
  ...
  try {
    ...
    // Integrar mapeo de sprites en el JSON final de Pokémon
    ...
    console.error('❌ Error al descargar los sprites:', err);
  }
