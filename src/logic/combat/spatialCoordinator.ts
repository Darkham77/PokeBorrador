...
const BASE_STANDING_TRAINER_SIZE_PLAYER_PX = 225;
const BASE_ENTITY_SIZE_ENEMY_PX = 200;
const BASE_BUSH_SIZE_PX = 60;
const BASE_PREVIEW_SIZE_PX = 120;
const BASE_POKEBALL_SIZE_PLAYER_PX = 27;
const BASE_POKEBALL_SIZE_ENEMY_PX = 18;
...
export const WORLD_CONSTANTS = {
  ...
  BASE_STANDING_TRAINER_SIZE_PLAYER: BASE_STANDING_TRAINER_SIZE_PLAYER_PX,
  BASE_ENTITY_SIZE_ENEMY: BASE_ENTITY_SIZE_ENEMY_PX,
  BASE_BUSH_SIZE: BASE_BUSH_SIZE_PX,
  BASE_PREVIEW_SIZE: BASE_PREVIEW_SIZE_PX,
  BASE_POKEBALL_SIZE_PLAYER: BASE_POKEBALL_SIZE_PLAYER_PX,
  BASE_POKEBALL_SIZE_ENEMY: BASE_POKEBALL_SIZE_ENEMY_PX,
  ...
  get STANDING_TRAINER_SIZE_PLAYER(): number { return this.BASE_STANDING_TRAINER_SIZE_PLAYER * this.OBJECT_SCALE },
  ...
  get POKEBALL_SIZE_PLAYER(): number { return this.BASE_POKEBALL_SIZE_PLAYER * this.OBJECT_SCALE },
  get POKEBALL_SIZE_ENEMY(): number { return this.BASE_POKEBALL_SIZE_ENEMY * this.OBJECT_SCALE }
}
