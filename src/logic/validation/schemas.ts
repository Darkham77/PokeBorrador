...
export const moveSchema = object({
  ...
  target: optional(union([literal('enemy'), literal('self'), literal('all')])),
...
export const pokemonSchema = object({
  ...
  moves: fallback(array(nullable(moveSchema)), []),
...
export const saveDataSchema = object({
  ...
  eggs: fallback(array(pokemonEggSchema), []),
  ...
  team: fallback(array(pokemonSchema), []),
  box: fallback(array(pokemonSchema), []),
  pokedex: fallback(array(string()), []),
  seenPokedex: fallback(array(string()), []),
  defeatedGyms: fallback(array(string()), []),
  ...
  rankedRewardsClaimed: fallback(array(string()), []),
  passiveTeamUids: fallback(array(string()), []),
  passiveTeamActive: fallback(boolean(), false),
  activeBattle: fallback(nullable(activeBattleSchema), null),
  daycare_missions: fallback(array(unknown()), []),
