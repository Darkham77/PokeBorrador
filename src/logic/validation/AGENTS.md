...
- Keep `schemas.ts` strictly as an export aggregator and composite schema validator (<200 SLOC). All domain-specific subschemas MUST reside under `subschemas/` (`authSchemas.ts`, `battleSchemas.ts`, `pokemonSchemas.ts`, `socialSchemas.ts`).
