...
export function getMoveDescription(id: string, mdProvided?: MoveBaseData | null): string {
  ...
  const effects: Record<string, string> = {
    ...
    'stat_down_enemy_spa_30': "Puede reducir el At. Especial del oponente (30%).",
    'stat_down_self_def': "Reduce la Defensa del usuario tras atacar.",
    'stat_down_self_spe': "Reduce la Velocidad del usuario tras atacar.",
