 ...
 * @returns {string} Mechanical weather key (e.g., 'sun')
 */
export function getMechanicalWeather(type) {
  ...
  if (!result) {
    console.warn(`[WeatherIntegrity] Token de clima no registrado detectado: "${type}". Por favor regístralo en weatherMapper.js para evitar inconsistencias mecánicas.`);
 ...
 */
export function getVisualWeather(type) {
 ...
 */
export const WEATHER_UI_METADATA = {
 ...
 */
export const WEATHER_VISUAL_METADATA = {
  'storm': {
    icon: '⚡',
    label: 'TORMENTA',
