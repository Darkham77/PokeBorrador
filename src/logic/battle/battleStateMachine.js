...
export function createBattleStateMachine() {
  ...
  const validTransitions = {
    ...
    [BATTLE_STATES.REWARDS_PHASE]: [BATTLE_STATES.POST_BATTLE_STABILIZATION, BATTLE_STATES.SEARCH_PHASE, BATTLE_STATES.INITIALIZING, BATTLE_STATES.EXIT_BATTLE, BATTLE_SUBSTATES.EMPTY_WAIT, BATTLE_SUBSTATES.DISTRIBUTE_XP],
