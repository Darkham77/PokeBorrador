...
Gym progression E2E tests validating challenge loops, consecutive trainers, and badge/money rewards.
...
- Run `npm run test:e2e:gyms` to verify gym progression tests.
