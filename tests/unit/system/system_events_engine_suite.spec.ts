...
import { FIRE_RED_MAPS, getMapLocationById } from '@/data/world/maps';
import {
  isEventActiveNow,
...
describe('System Events Engine Domain Suite', () => {
  beforeEach(() => {
    setActivePinia(createPinia());
  });

  describe('Core Event Scheduling & Calculation Logic', () => {
    ...
    it('handles robust parsing of stringified JSON config/schedule', () => {
      ...
      const monday = Temporal.Instant.from('2026-04-20T12:00:00Z');
  ...
  describe('Future-Proof Permutations & Map Integration', () => {
