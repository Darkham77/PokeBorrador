...
describe('Fix Egg Species IDs Migration Test', () => {
  it('should fix egg.id from egg_705821f6 to valid PokemonSpeciesId extracted from pokemonId/species/uid', () => {
    ...
    // Insert save with corrupted egg.id ('egg_705821f6') as produced by previous migration
    const mockSaveData = {
      trainer: 'ash',
      gender: 'h',
      badges: 8,
