...
describe('Reproduce Fuzzer Case 2b4f1e440640', () => {
  it('correctly executes all 108 turns deterministically in Showdown without pre-turn cheat promotion', () => {
    const fixturePath = path.resolve(process.cwd(), 'tests/fixtures/battle/case_2b4f1e440640.json');
    ...
    assert.strictEqual(match.id, 'case-2b4f1e440640');
