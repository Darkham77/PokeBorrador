...
describe('Reproduce Fuzzer Case 0c9c49792e14', () => {
  it('correctly executes all 22 turns deterministically in Showdown', () => {
    const fixturePath = path.resolve(process.cwd(), 'tests/fixtures/battle/case_0c9c49792e14.json');
    ...
    assert.strictEqual(match.id, 'case-0c9c49792e14');
