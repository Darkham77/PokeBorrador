    ...
    const ABILITIES = {
      ...
      caterpie: ['Escudo Polvo', 'Metamorfosis'], metapod: ['Mudar'], butterfree: ['Ojo Compuesto', 'Infiltrador'],
      weedle: ['Escudo Polvo', 'Metamorfosis'], kakuna: ['Mudar'], beedrill: ['Enjambre', 'Francotirador'],
      pidgey: ['Vista Lince', 'Alboroto'], pidgeotto: ['Vista Lince', 'Alboroto'], pidgeot: ['Vista Lince', 'Alboroto'],
      rattata: ['Escape', 'Correcaminos'], raticate: ['Escape', 'Agallas'],
      ...
      venonat: ['Ojo Compuesto'], venomoth: ['Ojo Compuesto', 'Escudo Polvo'],
      diglett: ['Trampa Arena'], dugtrio: ['Trampa Arena'],
      meowth: ['Recogida'], persian: ['Flexibilidad'],
      psyduck: ['Humedad', 'Obstruir'], golduck: ['Humedad', 'Obstruir'],
      ...
      pinsir: ['Corte Fuerte'],
      tauros: ['Intimidación'],
      magikarp: ['Escurridizo', 'Ráfaga'], gyarados: ['Intimidación'],
      lapras: ['Absorbe Agua'],
      ditto: ['Flexibilidad'],
      eevee: ['Escape', 'Adaptable'], vaporeon: ['Absorbe Agua'], jolteon: ['Absorbe Voltio'], flareon: ['Absorbe Fuego'],
      porygon: ['Calco'],
      omanyte: ['Caparazón'], omastar: ['Caparazón'],
