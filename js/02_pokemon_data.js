    ...
    const // Categories: 'physical' | 'special' | 'status'
      ...
      MOVE_DATA = {
        ...
        'Bofetón Lodo': { power: 20, acc: 100, type: 'normal', cat: 'special', pp: 20 },
        ...
        'Polución': {'power':30,'acc':70,'type':'poison','cat':'special','pp':20, 'effect':'poison_40'},
        ...
        'Hueso Palo': {'power':65,'acc':85,'type':'ground','cat':'physical','pp':20},        'Patada Ígnea': { power: 85, acc: 90, type: 'fire', cat: 'physical', pp: 10, effect: 'burn_10' },
        ...
        'Triturar': { power: 80, acc: 100, type: 'dark', cat: 'physical', pp: 15 },
        ...
        'Velo Sagrado': { power: 0, acc: 100, type: 'normal', cat: 'status', pp: 25 },
        ...
        'Bucle Arena': { power: 35, acc: 85, type: 'ground', cat: 'physical', pp: 15 },
        ...
        'Masa Cósmica': { power: 0, acc: 100, type: 'psíquico', cat: 'status', pp: 20, effect: 'stat_up_self_def_spd' },
        ...
        'Premonición': { power: 100, acc: 100, type: 'psychic', cat: 'special', pp: 15 },
        ...
        'Sorpresa': { power: 40, acc: 100, type: 'normal', cat: 'physical', pp: 10, effect: 'fake_out' },
        ...
        'Intercambio': { power: 0, acc: 100, type: 'psychic', cat: 'status', pp: 10 },
        ...
        'Día Soleado': { power: 0, acc: 100, type: 'fire', cat: 'status', pp: 5, effect: 'weather_sunny' },
        'Frío Polar': { power: 1, acc: 30, type: 'ice', cat: 'special', pp: 5, ohko: true },
        'Danza Lluvia': { power: 0, acc: 100, type: 'water', cat: 'status', pp: 5, effect: 'weather_rain' },
        'Velo Sagrado': { power: 0, acc: 100, type: 'normal', cat: 'status', pp: 25 },
        'Tumba Rocas': { power: 50, acc: 80, type: 'rock', cat: 'physical', pp: 10, effect: 'stat_down_enemy_spe' },
        'Tormenta Arena': { power: 0, acc: 100, type: 'rock', cat: 'status', pp: 10, effect: 'weather_sandstorm' },
        'Cola Férrea': { power: 100, acc: 75, type: 'steel', cat: 'physical', pp: 15, effect: 'stat_down_enemy_def_10' },
        ...
        'Doble Ataque': { power: 25, acc: 95, type: 'bug', cat: 'physical', pp: 20 },
    ...
    const ABILITY_DATA = {
      ...
      'Foco Interno': 'Protege al Pokémon y evita que retroceder ante ataques del rival.',
