    ...
    const POKEMON_DB = {
      ...
      cloyster: {
        ...
        learnset: [{ lv: 1, name: 'Clavo Cañón', pp: 15 }, { lv: 1, name: 'Supersónico', pp: 20 }, { lv: 1, name: 'Rayo Aurora', pp: 20 }, { lv: 1, name: 'Tenaza', pp: 10 }]
      },
      gastly: {
      ...
      omanyte: {
        ...
        learnset: [{ lv: 1, name: 'Pistola Agua', pp: 25 }, { lv: 1, name: 'Refugio', pp: 40 }, { lv: 39, name: 'Tenaza', pp: 10 }, { lv: 46, name: 'Hidrobomba', pp: 5 }]
      },
      omastar: {
        name: 'Omastar', emoji: '🐚', type: 'rock', hp: 70, atk: 60, def: 125, spa: 115, spd: 70, spe: 55,
        learnset: [{ lv: 1, name: 'Pistola Agua', pp: 25 }, { lv: 39, name: 'Tenaza', pp: 10 }, { lv: 53, name: 'Hidrobomba', pp: 5 }]
      },
      kabuto: {
    ...
    const // Categories: 'physical' | 'special' | 'status'
      ...
      MOVE_DATA = {
        ...
        'Hiperrayo': { power: 150, acc: 90, type: 'normal', cat: 'physical', pp: 5, effect: 'recharge' },
        ...
        'Enfado': { power: 120, acc: 100, type: 'dragon', cat: 'special', pp: 10 },
        ...
        'Golpe': { power: 40, acc: 100, type: 'normal', cat: 'physical', pp: 35 },
        ...
        'Tenaza': {'power':35,'acc':85,'type':'water','cat':'special','pp':10,'effect':'bind'},
        ...
        'Aire Afilado': {'power':60,'acc':95,'type':'flying','cat':'physical','pp':25},
        'Residuos': {'power':65,'acc':100,'type':'poison','cat':'physical','pp':20, 'effect':'poison_30'},
        'Polución': {'power':30,'acc':70,'type':'poison','cat':'physical','pp':20, 'effect':'poison_40'},
        'Ácido': {'power':40,'acc':100,'type':'poison','cat':'physical','pp':30, 'effect':'stat_down_enemy_def_10'},
        ...
        'Hueso Palo': {'power':65,'acc':85,'type':'ground','cat':'physical','pp':20},        'Patada Ígnea': { power: 85, acc: 90, type: 'fire', cat: 'special', pp: 10, effect: 'burn_10' },
        ...
        'Triataque': {'power':80,'acc':100,'type':'normal','cat':'physical','pp':10,'effect':'tri_attack'},
        ...
        'Alboroto': { power: 90, acc: 100, type: 'normal', cat: 'physical', pp: 10, sound: true },
        ...
        'Puño Fuego': { power: 75, acc: 100, type: 'fire', cat: 'special', pp: 15, effect: 'burn_10' },
        // ── Water ────────────────────────────────────────────────
        ...
        'Puño Trueno': { power: 75, acc: 100, type: 'electric', cat: 'special', pp: 15, effect: 'paralyze_10' },
        // ── Psychic ──────────────────────────────────────────────
        ...
        'Psicocorte': { power: 70, acc: 100, type: 'psychic', cat: 'special', pp: 20 },
        ...
        // ── Flying ───────────────────────────────────────────────
        'Tornado': { power: 40, acc: 100, type: 'flying', cat: 'physical', pp: 35 },
        ...
        'Bomba Lodo': { power: 90, acc: 100, type: 'poison', cat: 'physical', pp: 10, effect: 'poison_30' },
        ...
        'Bola Sombra': { power: 80, acc: 100, type: 'ghost', cat: 'physical', pp: 15, effect: 'stat_down_enemy_spd_20' },
        ...
        'Martillazo': { power: 100, acc: 90, type: 'water', cat: 'special', pp: 10 },
        ...
        'Garra Dragón': { power: 80, acc: 100, type: 'dragon', cat: 'special', pp: 15 },
