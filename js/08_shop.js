    ...
    const SHOP_ITEMS = [
      ...
      { id: 'tm04', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-psychic.png', name: 'MT04 Paz Mental', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: false, bcPrice: 1500, desc: 'Enseña Paz Mental. Sube At. Esp. y Def. Esp.', effect: (qty) => { state.inventory['MT Paz Mental'] = (state.inventory['MT Paz Mental'] || 0) + qty; } },
      ...
      { id: 'tm26', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-ground.png', name: 'MT26 Terremoto', icon: '📀', price: 0, unlockLv: 25, tier: 'legend', market: false, trainerShop: false, bcPrice: 5000, desc: 'Enseña Terremoto. El mejor ataque de tierra.', effect: (qty) => { state.inventory['MT Terremoto'] = (state.inventory['MT Terremoto'] || 0) + qty; } },
      ...
      { id: 'tm34', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-electric.png', name: 'MT34 Onda Voltio', icon: '📀', price: 0, unlockLv: 12, tier: 'rare', market: false, trainerShop: false, bcPrice: 1500, desc: 'Enseña Onda Voltio. Nunca falla.', effect: (qty) => { state.inventory['MT Onda Voltio'] = (state.inventory['MT Onda Voltio'] || 0) + qty; } },
      ...
      { id: 'tm39', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-rock.png', name: 'MT39 Tumba Rocas', icon: '📀', price: 0, unlockLv: 12, tier: 'rare', market: false, trainerShop: false, bcPrice: 1500, desc: 'Enseña Tumba Rocas. Baja la velocidad.', effect: (qty) => { state.inventory['MT Tumba Rocas'] = (state.inventory['MT Tumba Rocas'] || 0) + qty; } },
