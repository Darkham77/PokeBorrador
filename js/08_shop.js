    ...
    const SHOP_ITEMS = [
      ...
      { id: 'tm01', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-fighting.png', name: 'MT01 Puño Certero', icon: '📀', price: 0, unlockLv: 15, tier: 'epic', market: false, trainerShop: true, bcPrice: 2500, desc: 'Enseña Puño Certero. Requiere concentración.', effect: (qty) => { state.inventory['MT Puño Certero'] = (state.inventory['MT Puño Certero'] || 0) + qty; } },
      { id: 'tm02', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-dragon.png', name: 'MT02 Garra Dragón', icon: '📀', price: 0, unlockLv: 12, tier: 'rare', market: false, trainerShop: true, bcPrice: 2500, desc: 'Enseña Garra Dragón. Poderoso ataque de tipo Dragón.', effect: (qty) => { state.inventory['MT Garra Dragón'] = (state.inventory['MT Garra Dragón'] || 0) + qty; } },
      { id: 'tm03', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-water.png', name: 'MT03 Hidropulso', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Hidropulso. Puede confundir al rival.', effect: (qty) => { state.inventory['MT Hidropulso'] = (state.inventory['MT Hidropulso'] || 0) + qty; } },
      { id: 'tm04', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-psychic.png', name: 'MT04 Paz Mental', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Paz Mental. Sube At. Esp. y Def. Esp.', effect: (qty) => { state.inventory['MT Paz Mental'] = (state.inventory['MT Paz Mental'] || 0) + qty; } },
      { id: 'tm05', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png', name: 'MT05 Rugido', icon: '📀', price: 0, unlockLv: 5, tier: 'common', market: false, trainerShop: true, bcPrice: 1000, desc: 'Enseña Rugido. Ahuyenta al rival.', effect: (qty) => { state.inventory['MT Rugido'] = (state.inventory['MT Rugido'] || 0) + qty; } },
      { id: 'tm06', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-poison.png', name: 'MT06 Tóxico', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 2500, desc: 'Enseña Tóxico. Envenena gravemente al rival.', effect: (qty) => { state.inventory['MT Tóxico'] = (state.inventory['MT Tóxico'] || 0) + qty; } },
      { id: 'tm07', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-ice.png', name: 'MT07 Granizo', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Granizo. Crea una tormenta de hielo.', effect: (qty) => { state.inventory['MT Granizo'] = (state.inventory['MT Granizo'] || 0) + qty; } },
      { id: 'tm08', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-fighting.png', name: 'MT08 Corpulencia', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Corpulencia. Sube Ataque y Defensa.', effect: (qty) => { state.inventory['MT Corpulencia'] = (state.inventory['MT Corpulencia'] || 0) + qty; } },
      { id: 'tm09', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-grass.png', name: 'MT09 Recurrente', icon: '📀', price: 0, unlockLv: 8, tier: 'common', market: false, trainerShop: true, bcPrice: 1000, desc: 'Enseña Recurrente. Ataca 2-5 veces.', effect: (qty) => { state.inventory['MT Recurrente'] = (state.inventory['MT Recurrente'] || 0) + qty; } },
      { id: 'tm10', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png', name: 'MT10 Poder Oculto', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 2500, desc: 'Enseña Poder Oculto. El tipo varía según el Pokémon.', effect: (qty) => { state.inventory['MT Poder Oculto'] = (state.inventory['MT Poder Oculto'] || 0) + qty; } },
      { id: 'tm11', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-fire.png', name: 'MT11 Día Soleado', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Día Soleado. Despierta un sol radiante.', effect: (qty) => { state.inventory['MT Día Soleado'] = (state.inventory['MT Día Soleado'] || 0) + qty; } },
      { id: 'tm12', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-dark.png', name: 'MT12 Mofa', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Mofa. Impide movimientos de estado.', effect: (qty) => { state.inventory['MT Mofa'] = (state.inventory['MT Mofa'] || 0) + qty; } },
      { id: 'tm13', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-ice.png', name: 'MT13 Rayo Hielo', icon: '📀', price: 0, unlockLv: 20, tier: 'epic', market: false, trainerShop: true, bcPrice: 5000, desc: 'Enseña Rayo Hielo. Puede congelar al rival.', effect: (qty) => { state.inventory['MT Rayo Hielo'] = (state.inventory['MT Rayo Hielo'] || 0) + qty; } },
      { id: 'tm14', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-ice.png', name: 'MT14 Ventisca', icon: '📀', price: 0, unlockLv: 25, tier: 'legend', market: false, trainerShop: true, bcPrice: 5000, desc: 'Enseña Ventisca. Poderoso ataque de hielo.', effect: (qty) => { state.inventory['MT Ventisca'] = (state.inventory['MT Ventisca'] || 0) + qty; } },
      { id: 'tm15', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png', name: 'MT15 Hiperrayo', icon: '📀', price: 0, unlockLv: 25, tier: 'legend', market: false, trainerShop: true, bcPrice: 5000, desc: 'Enseña Hiperrayo. Potencia máxima, requiere descanso.', effect: (qty) => { state.inventory['MT Hiperrayo'] = (state.inventory['MT Hiperrayo'] || 0) + qty; } },
      { id: 'tm16', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-psychic.png', name: 'MT16 Pantalla de Luz', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Pantalla Luz. Reduce daño especial.', effect: (qty) => { state.inventory['MT Pantalla de Luz'] = (state.inventory['MT Pantalla de Luz'] || 0) + qty; } },
      { id: 'tm17', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png', name: 'MT17 Protección', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 2500, desc: 'Enseña Protección. Evita ataques ese turno.', effect: (qty) => { state.inventory['MT Protección'] = (state.inventory['MT Protección'] || 0) + qty; } },
      { id: 'tm18', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-water.png', name: 'MT18 Danza Lluvia', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Danza Lluvia. Invoca la lluvia.', effect: (qty) => { state.inventory['MT Danza Lluvia'] = (state.inventory['MT Danza Lluvia'] || 0) + qty; } },
      { id: 'tm19', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-grass.png', name: 'MT19 Gigadrenado', icon: '📀', price: 0, unlockLv: 15, tier: 'rare', market: false, trainerShop: true, bcPrice: 2500, desc: 'Enseña Gigadrenado. Roba vida al rival.', effect: (qty) => { state.inventory['MT Gigadrenado'] = (state.inventory['MT Gigadrenado'] || 0) + qty; } },
      { id: 'tm20', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png', name: 'MT20 Velo Sagrado', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Velo Sagrado. Protege de estados.', effect: (qty) => { state.inventory['MT Velo Sagrado'] = (state.inventory['MT Velo Sagrado'] || 0) + qty; } },
      { id: 'tm21', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png', name: 'MT21 Frustración', icon: '📀', price: 0, unlockLv: 5, tier: 'common', market: false, trainerShop: true, bcPrice: 1000, desc: 'Enseña Frustración. Más fuerte si te odia.', effect: (qty) => { state.inventory['MT Frustración'] = (state.inventory['MT Frustración'] || 0) + qty; } },
      { id: 'tm22', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-grass.png', name: 'MT22 Rayo Solar', icon: '📀', price: 0, unlockLv: 20, tier: 'epic', market: false, trainerShop: true, bcPrice: 3500, desc: 'Enseña Rayo Solar. Tarda un turno en cargar.', effect: (qty) => { state.inventory['MT Rayo Solar'] = (state.inventory['MT Rayo Solar'] || 0) + qty; } },
      { id: 'tm23', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-steel.png', name: 'MT23 Cola Férrea', icon: '📀', price: 0, unlockLv: 12, tier: 'rare', market: false, trainerShop: true, bcPrice: 2000, desc: 'Enseña Cola Férrea. Puede bajar la defensa.', effect: (qty) => { state.inventory['MT Cola Férrea'] = (state.inventory['MT Cola Férrea'] || 0) + qty; } },
      { id: 'tm24', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-electric.png', name: 'MT24 Rayo', icon: '📀', price: 0, unlockLv: 20, tier: 'epic', market: false, trainerShop: true, bcPrice: 5000, desc: 'Enseña Rayo. Ataque eléctrico fiable.', effect: (qty) => { state.inventory['MT Rayo'] = (state.inventory['MT Rayo'] || 0) + qty; } },
      { id: 'tm25', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-electric.png', name: 'MT25 Trueno', icon: '📀', price: 0, unlockLv: 25, tier: 'legend', market: false, trainerShop: true, bcPrice: 5000, desc: 'Enseña Trueno. Máximo poder, poca precisión.', effect: (qty) => { state.inventory['MT Trueno'] = (state.inventory['MT Trueno'] || 0) + qty; } },
      { id: 'tm26', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-ground.png', name: 'MT26 Terremoto', icon: '📀', price: 0, unlockLv: 25, tier: 'legend', market: false, trainerShop: true, bcPrice: 5000, desc: 'Enseña Terremoto. El mejor ataque de tierra.', effect: (qty) => { state.inventory['MT Terremoto'] = (state.inventory['MT Terremoto'] || 0) + qty; } },
      { id: 'tm27', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png', name: 'MT27 Retribución', icon: '📀', price: 0, unlockLv: 5, tier: 'common', market: false, trainerShop: true, bcPrice: 1000, desc: 'Enseña Retribución. Más fuerte si te quiere.', effect: (qty) => { state.inventory['MT Retribución'] = (state.inventory['MT Retribución'] || 0) + qty; } },
      { id: 'tm28', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-ground.png', name: 'MT28 Excavar', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 2000, desc: 'Enseña Excavar. Se oculta bajo tierra.', effect: (qty) => { state.inventory['MT Excavar'] = (state.inventory['MT Excavar'] || 0) + qty; } },
      { id: 'tm29', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-psychic.png', name: 'MT29 Psíquico', icon: '📀', price: 0, unlockLv: 20, tier: 'epic', market: false, trainerShop: true, bcPrice: 5000, desc: 'Enseña Psíquico. El mejor ataque psíquico.', effect: (qty) => { state.inventory['MT Psíquico'] = (state.inventory['MT Psíquico'] || 0) + qty; } },
      { id: 'tm30', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-ghost.png', name: 'MT30 Bola Sombra', icon: '📀', price: 0, unlockLv: 15, tier: 'rare', market: false, trainerShop: true, bcPrice: 3500, desc: 'Enseña Bola Sombra. Gran ataque de tipo Fantasma.', effect: (qty) => { state.inventory['MT Bola Sombra'] = (state.inventory['MT Bola Sombra'] || 0) + qty; } },
      { id: 'tm31', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-fighting.png', name: 'MT31 Demolición', icon: '📀', price: 0, unlockLv: 12, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Demolición. Destruye pantallas.', effect: (qty) => { state.inventory['MT Demolición'] = (state.inventory['MT Demolición'] || 0) + qty; } },
      { id: 'tm32', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png', name: 'MT32 Doble Equipo', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 2500, desc: 'Enseña Doble Equipo. Sube la evasión.', effect: (qty) => { state.inventory['MT Doble Equipo'] = (state.inventory['MT Doble Equipo'] || 0) + qty; } },
      { id: 'tm33', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-psychic.png', name: 'MT33 Reflejo', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Reflejo. Reduce daño físico.', effect: (qty) => { state.inventory['MT Reflejo'] = (state.inventory['MT Reflejo'] || 0) + qty; } },
      { id: 'tm34', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-electric.png', name: 'MT34 Onda Voltio', icon: '📀', price: 0, unlockLv: 12, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Onda Voltio. Nunca falla.', effect: (qty) => { state.inventory['MT Onda Voltio'] = (state.inventory['MT Onda Voltio'] || 0) + qty; } },
      { id: 'tm35', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-fire.png', name: 'MT35 Lanzallamas', icon: '📀', price: 0, unlockLv: 20, tier: 'epic', market: false, trainerShop: true, bcPrice: 5000, desc: 'Enseña Lanzallamas. Ataque ígneo fiable.', effect: (qty) => { state.inventory['MT Lanzallamas'] = (state.inventory['MT Lanzallamas'] || 0) + qty; } },
      { id: 'tm36', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-poison.png', name: 'MT36 Bomba Lodo', icon: '📀', price: 0, unlockLv: 15, tier: 'rare', market: false, trainerShop: true, bcPrice: 3500, desc: 'Enseña Bomba Lodo. Puede envenenar.', effect: (qty) => { state.inventory['MT Bomba Lodo'] = (state.inventory['MT Bomba Lodo'] || 0) + qty; } },
      { id: 'tm37', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-rock.png', name: 'MT37 Tormenta de Arena', icon: '📀', price: 0, unlockLv: 15, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña T. Arena. Tormenta de arena.', effect: (qty) => { state.inventory['MT Tormenta de Arena'] = (state.inventory['MT Tormenta de Arena'] || 0) + qty; } },
      { id: 'tm38', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-fire.png', name: 'MT38 Llamarada', icon: '📀', price: 0, unlockLv: 25, tier: 'legend', market: false, trainerShop: true, bcPrice: 5000, desc: 'Enseña Llamarada. Máximo poder de fuego.', effect: (qty) => { state.inventory['MT Llamarada'] = (state.inventory['MT Llamarada'] || 0) + qty; } },
      { id: 'tm39', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-rock.png', name: 'MT39 Tumba Rocas', icon: '📀', price: 0, unlockLv: 12, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Tumba Rocas. Baja la velocidad.', effect: (qty) => { state.inventory['MT Tumba Rocas'] = (state.inventory['MT Tumba Rocas'] || 0) + qty; } },
      { id: 'tm40', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-flying.png', name: 'MT40 Golpe Aéreo', icon: '📀', price: 0, unlockLv: 15, tier: 'rare', market: false, trainerShop: true, bcPrice: 2000, desc: 'Enseña Golpe Aéreo. Nunca falla.', effect: (qty) => { state.inventory['MT Golpe Aéreo'] = (state.inventory['MT Golpe Aéreo'] || 0) + qty; } },
      { id: 'tm41', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-dark.png', name: 'MT41 Tormento', icon: '📀', price: 0, unlockLv: 15, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Tormento. Impide repetir ataques.', effect: (qty) => { state.inventory['MT Tormento'] = (state.inventory['MT Tormento'] || 0) + qty; } },
      { id: 'tm42', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png', name: 'MT42 Imagen', icon: '📀', price: 0, unlockLv: 15, tier: 'rare', market: false, trainerShop: true, bcPrice: 2500, desc: 'Enseña Imagen. Se potencia con estados.', effect: (qty) => { state.inventory['MT Imagen'] = (state.inventory['MT Imagen'] || 0) + qty; } },
      { id: 'tm43', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png', name: 'MT43 Daño Secreto', icon: '📀', price: 0, unlockLv: 15, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Daño Secreto. Efecto según terreno.', effect: (qty) => { state.inventory['MT Daño Secreto'] = (state.inventory['MT Daño Secreto'] || 0) + qty; } },
      { id: 'tm44', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-psychic.png', name: 'MT44 Descanso', icon: '📀', price: 0, unlockLv: 20, tier: 'epic', market: false, trainerShop: true, bcPrice: 2000, desc: 'Enseña Descanso. Duerme y cura HP.', effect: (qty) => { state.inventory['MT Descanso'] = (state.inventory['MT Descanso'] || 0) + qty; } },
      { id: 'tm45', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png', name: 'MT45 Atracción', icon: '📀', price: 0, unlockLv: 15, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Atracción. Enamora al rival.', effect: (qty) => { state.inventory['MT Atracción'] = (state.inventory['MT Atracción'] || 0) + qty; } },
      { id: 'tm46', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-dark.png', name: 'MT46 Ladrón', icon: '📀', price: 0, unlockLv: 10, tier: 'rare', market: false, trainerShop: true, bcPrice: 1500, desc: 'Enseña Ladrón. Puede robar el item.', effect: (qty) => { state.inventory['MT Ladrón'] = (state.inventory['MT Ladrón'] || 0) + qty; } },
      { id: 'tm47', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-steel.png', name: 'MT47 Ala de Acero', icon: '📀', price: 0, unlockLv: 12, tier: 'rare', market: false, trainerShop: true, bcPrice: 2000, desc: 'Enseña Ala de Acero. Puede subir defensa.', effect: (qty) => { state.inventory['MT Ala de Acero'] = (state.inventory['MT Ala de Acero'] || 0) + qty; } },
      { id: 'tm48', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-psychic.png', name: 'MT48 Intercambio', icon: '📀', price: 0, unlockLv: 22, tier: 'epic', market: false, trainerShop: true, bcPrice: 2500, desc: 'Enseña Intercambio. Cambia habilidades.', effect: (qty) => { state.inventory['MT Intercambio'] = (state.inventory['MT Intercambio'] || 0) + qty; } },
      { id: 'tm49', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-dark.png', name: 'MT49 Robo', icon: '📀', price: 0, unlockLv: 22, tier: 'epic', market: false, trainerShop: true, bcPrice: 2500, desc: 'Enseña Robo. Roba el efecto positivo.', effect: (qty) => { state.inventory['MT Robo'] = (state.inventory['MT Robo'] || 0) + qty; } },
      { id: 'tm50', cat: 'especial', sprite: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-fire.png', name: 'MT50 Sofoco', icon: '📀', price: 0, unlockLv: 25, tier: 'legend', market: false, trainerShop: true, bcPrice: 5000, desc: 'Enseña Sofoco. Máximo poder, baja At. Esp.', effect: (qty) => { state.inventory['MT Sofoco'] = (state.inventory['MT Sofoco'] || 0) + qty; } },
      {
