...
description: COMMAND AND ORCHESTRATE automatic agent selection and intelligent task routing. ANALYZE user requests and AUTOMATICALLY SELECT the best specialist agent(s) without requiring explicit user mentions. NEVER guess; always route based on expertise.
version: 1.0.0
---
...
| **Testing** | test, test, vitest, playwright, cypress | `test-engineer` |
