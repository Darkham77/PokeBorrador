---
name: mcp-builder
description: ARCHITECT and IMPLEMENT MCP (Model Context Protocol) servers. DESIGN robust tools, resources, and templates using industry-leading patterns. ELIMINATE friction between AI and external systems.
