...
### 1. Performance Symptom Decision Tree
...
| Priority | Action |
| :--- | :--- |
| **CRITICAL** | **Eliminate waterfalls** (Section 1) and **Optimize bundle size** (Section 2). |
| **HIGH** | **Optimize server-side performance** (Section 3). |
| **MEDIUM** | **Optimize re-renders** (Section 5) and **Client-side data fetching** (Section 4). |
| **LOW** | **Optimize JavaScript performance** (Section 7) and **Advanced patterns** (Section 8). |
...
| TypeScript patterns | [typescript-expert](../typescript-expert/SKILL.md) |
| Deployment & DevOps | [deployment-procedures](../deployment-procedures/SKILL.md) |
