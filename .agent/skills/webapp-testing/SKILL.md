---
name: webapp-testing
description: MASTER web application testing principles. YOU MUST use E2E, Playwright, and deep audit strategies to ensure zero-regressions and flawless user experiences. Audit tirelessly.
